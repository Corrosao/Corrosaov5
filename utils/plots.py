...
# def plot_one_circle(x, img, color=None, label=None, line_thickness=3):
#     # Plots one bounding box on image img
#     tl = line_thickness or round(0.002 * (img.shape[0] + img.shape[1]) / 2) + 1  # line/font thickness
#     # color = color or [random.randint(0, 255) for _ in range(3)]
#     color = [0, 0, 255]
#     c1, c2 = (int(x[0]), int(x[1])), (int(x[2]), int(x[3]))
#     radius = int(abs(c1[1] - c1[0])/4)
#     # print(f"radius: {radius}, {c1[1]}, {c1[0]}, {c2[1]}, {c2[0]} ")
#     # print(f"c1: {c1}, c2: {c2}")
#     # print(f"img.shape[0]: {img.shape[0]}, img.shape[1]: {img.shape[1]}")
#     cv2.circle(img, x, radius, color, -1)
...
def plot_one_box_scatter(x, img, color=None, label=None, line_thickness=3):
    # Plots one bounding box on image img
    tl = line_thickness or round(0.002 * (img.shape[0] + img.shape[1]) / 2) + 1  # line/font thickness
    # color = color or [random.randint(0, 255) for _ in range(3)]
    color = [0, 0, 255]
